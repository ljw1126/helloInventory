package com.example.inventory.test.binder;
...
public class KafkaOutputDestination {
    ...
    // inventory topic으로부터 message를 받아서 반환
    ...
    private ConsumerRecord<String, String> getOneRecord(String brokerAddresses, String group, String topic, int partition,
        ...
        consumerConfig.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class); //import 주의
